 var carousel = (function(){
        function _carousel(opt){
            this.$ct = opt.$ct;
            this.autoPlay = opt.autoPlay;
            this.playInterval = opt.playInterval
            this.init();
            this.bind();
            this.autoPlay?this.autoPlayer(this.playInterval):undefined
        }
       ...
       _carousel.prototype.playPre = function(){
        ...
        _carousel.prototype.autoPlayer = function(time){
              var _this = this
